 ...
 */
    ...
    //AJOUTER SI pas training de l'utilisateur redirigé vers list programme
    $req_id_training = $bdd->prepare('SELECT COUNT(id_training) AS id FROM TRAINING WHERE id_training = ?');
    $req_id_training->execute(array($_GET['id']));
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active"><a href="training.php">Listes des Programmes</a> <span class="text-muted">/</span> Programme </li>
                    </ol>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <button class="btn btn-link text-dark float-end" onclick="create_exercise()"><i
                                ...
                                <button class="btn btn-link text-dark float-end" onclick="create_exercise()"><i class="fa-solid fa-plus"></i></button>
                                </form>
                            </div>
            ...
            <div id="scripttoreload">
                <script src="js/edit_training.js"></script>
            </div>
