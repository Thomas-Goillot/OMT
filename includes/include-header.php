        ...
        <nav
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <li><a href="shop.php" class="nav-link px-2 link-dark">Boutique</a></li>
                </ul>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        ...
                        <?php 
                            ...
                            if($user_info['permissions_level'] == 1){
                                echo '<li><a class="dropdown-item" href="dashboard/admin">Parametres</a></li>';
                            }
                            else{
                                echo '<li><a class="dropdown-item" href="dashboard">Parametres</a></li>';
                            }
